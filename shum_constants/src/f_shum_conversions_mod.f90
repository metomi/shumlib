...
REAL(KIND=real32),    PARAMETER ::                                            &
         shum_rhour_per_sec_const_32 = REAL(shum_rhour_per_sec_const,real32)
REAL(KIND=real32),    PARAMETER ::                                            &
         shum_rday_per_hour_const_32 = REAL(shum_rday_per_hour_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_pi_const_32            = REAL(shum_pi_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_pi_over_180_const_32   = REAL(shum_pi_over_180_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_180_over_pi_const_32   = REAL(shum_180_over_pi_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_zerodegc_const_32      = REAL(shum_zerodegc_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_kt2ms_const_32         = REAL(shum_kt2ms_const,real32)
REAL(KIND=real32), PARAMETER ::                                               &
         shum_ft2m_const_32          = REAL(shum_ft2m_const,real32)
